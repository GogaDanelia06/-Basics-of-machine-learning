...
val = [
      (1,"Goga", "Danelia",20,datetime.date(1999, 10, 06),datetime.date(2020, 10, 28),12345,"Male"),
      (2,"Luka", "Nebieridze",18,datetime.date(1999, 08, 21),datetime.date(2020, 10, 28),54321,"Female"),
      (3,"Lado", "Nikuradze",20,datetime.date(1998, 3, 2),datetime.date(2020, 10, 27),10234,"Male"),
      (4,"Shako", "Bardzimashvili",30,datetime.date(2013,11,2),datetime.date(2020, 10, 27),21234,"Male"),
      (5,"Tamo", "Kvaracxelia",30,datetime.date(2007,12,14),datetime.date(2020, 10, 20),21534,"Female")
      ]
